...
export default {
  ...
  de_DE: {
    ...
    4: 'Weboberfläche',
    5: 'Die Weboberfläche von Blisspoint',
  },
  pl_PL: {
    0: 'Uruchamianie Blisspoint',
    1: 'Interfejs webowy',
    2: 'Interfejs webowy jest gotowy',
    3: 'Interfejs webowy nie jest gotowy',
    4: 'Interfejs webowy',
    5: 'Interfejs webowy Blisspoint',
  },
  fr_FR: {
    0: 'Démarrage de Blisspoint',
    1: 'Interface web',
    2: "L'interface web est prête",
    3: "L'interface web n'est pas prête",
    4: 'Interface web',
    5: "L'interface web de Blisspoint",
  },
