...
export const current = VersionInfo.of({
  version: '0.6.0:0',
  releaseNotes: {
    en_US: `First release of Blisspoint on StartOS, built on upstream 0.6.0.
...
Full notes: https://github.com/heatpunk/blisspoint/releases/tag/v0.6.0`,
    es_ES: `Primera versión de Blisspoint en StartOS, basada en la 0.6.0 original.
...
Notas completas: https://github.com/heatpunk/blisspoint/releases/tag/v0.6.0`,
    de_DE: `Erste Veröffentlichung von Blisspoint auf StartOS, basierend auf Upstream 0.6.0.
...
Vollständige Hinweise: https://github.com/heatpunk/blisspoint/releases/tag/v0.6.0`,
    pl_PL: `Pierwsze wydanie Blisspoint na StartOS, oparte na wersji 0.6.0 projektu źródłowego.
...
Pełne informacje: https://github.com/heatpunk/blisspoint/releases/tag/v0.6.0`,
    fr_FR: `Première version de Blisspoint sur StartOS, basée sur la version 0.6.0 du projet d'origine.
